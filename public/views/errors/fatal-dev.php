...
<body style="border: 2px solid red; padding: 1rem;">
...
<b>[Message]:</b> <?= str_replace(['thrown', 'Stack trace:', ':'.$lastError['line']], ['', '<br /><b>[Trace]:</b>', ''], $lastError['message']);?>
 ...
 <a style="border: 1px solid rgba(0,0,0,0.6); padding: 1rem; text-decoration: none; color :rgba(0,0,0,0.6); font-family: 'Nunito', sans-serif; margin: 0 auto;"
